...
namespace projekateParking.ViewModel
{
    public class Registracija
    {
        ...
        public string VratiSesiju(int index)
        {
            string povratak = "";
            povratak += "Registarske oznake vozila: " + this.vozilo.registarskeOznake + "\n"; 
            povratak += "ID:\t";
            povratak += this.sesijaokoristenjuparkinga[index].ID.ToString() + "\n";
            povratak += "Vrijeme dolaska:\t";
            povratak += this.sesijaokoristenjuparkinga[index].vrijemeDolaska.ToString() + "\n";
            povratak += "Mjesto na parkingu:\t";
            povratak += this.sesijaokoristenjuparkinga[index].mjesto.ToString() + "\n";
            return povratak;
        }
    }
}
