...
namespace projekateParking.ViewModel
{
    public class eParking
    {
        ...
        public eParking()
        {
            ...
            listaKorisnika[0].dodajRegistraciju(new Registracija(DateTime.Now, DateTime.Now, "", false, new Vozilo("A12-A-345", 12, "MAN", "DA", "da")));
            listaKorisnika[0].dodajRegistraciju(new Registracija(DateTime.Now, DateTime.Now, "", false, new Vozilo("K63-M-058 BIH", 12, "D", "d", "d")));
        }
